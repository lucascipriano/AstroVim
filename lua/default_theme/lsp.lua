...
local lsp = {
  DiagnosticError = vim.tbl_deep_extend("force", user_settings.diagnostics_style, { fg = C.red_1 }),
  DiagnosticWarn = vim.tbl_deep_extend("force", user_settings.diagnostics_style, { fg = C.orange_1 }),
  DiagnosticInfo = vim.tbl_deep_extend("force", user_settings.diagnostics_style, { fg = C.white_2 }),
  DiagnosticHint = vim.tbl_deep_extend("force", user_settings.diagnostics_style, { fg = C.yellow_1 }),
